...
from paper_experiments.experiments.hindsight import box2d
...
def run(
    ...
    density_model = box2d.DensityEstimator(
    ...
    agent = uvd.UVDTD3(
        functools.partial(box2d.make_env,
                          env_name,
                          progressive_noise,
                          max_path_len,
