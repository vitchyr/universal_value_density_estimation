...
from paper_experiments.experiments.hindsight import metaworld
...
def run(env_name: str, progressive_noise: bool, reward_factor: float,
    ...
    agent = uvd.UVDTD3(
        functools.partial(metaworld.make_env, env_name, progressive_noise,
                          small_goal), device, density_model, q1, q2,
        policy, params)
    metaworld.train_metaworld(experiment, agent, eval_env, progressive_noise,
                      small_goal)
